...
public class PodcastFavouritesComperator  implements Comparator<Podcast>{

	@Override
	public int compare(Podcast o1, Podcast o2) {
		if(o1.getNumberOfFavEpisodersNum() > o2.getNumberOfFavEpisodersNum())
			return 1;
		if(o1.getNumberOfFavEpisodersNum() < o2.getNumberOfFavEpisodersNum())
			return -1;
		if(o1.getNumberOfFavEpisodersNum() == o2.getNumberOfFavEpisodersNum())
			return new PodcastAlphabeticalComperator().compare(o1,o2);
		return 0;
	}
